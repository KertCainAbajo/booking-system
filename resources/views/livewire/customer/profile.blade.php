<div class="space-y-6">
    ...
    <div class="mb-4">
        <a href="{{ route('customer.dashboard') }}" wire:navigate class="inline-flex items-center px-6 py-3 bg-garage-forest hover:bg-garage-darkgreen text-white font-bold rounded-lg transition-all border border-garage-neon/30 hover:border-garage-neon/50 service-tag">
    ...
    <div class="bg-gradient-to-br from-garage-charcoal to-garage-darkgreen rounded-lg shadow-garage p-8 border-l-4 border-garage-neon relative overflow-hidden">
        ...
        <div class="relative z-10">
            <div class="flex items-center space-x-4 mb-3">
                ...
                <h1 class="text-4xl font-bold text-white service-tag tracking-wider">CUSTOMER PROFILE</h1>
            </div>
            <p class="text-white text-lg ml-16">Manage your personal information</p>
        </div>
    ...
    <div class="bg-gradient-to-br from-garage-charcoal to-garage-darkgreen rounded-lg shadow-garage p-6 border border-garage-neon/20">
        <div class="flex items-center space-x-3 mb-6">
            ...
            <h3 class="text-xl font-bold text-white service-tag tracking-wider">PROFILE INFORMATION</h3>
        </div>
        ...
        <form wire:submit.prevent="updateProfile" class="space-y-5">
            <div>
                <label for="name" class="block text-sm font-bold text-white mb-2 service-tag tracking-wider">
                ...
                <input 
                    ...
                    id="name" 
                    wire:model="name" 
                    class="w-full px-4 py-3 bg-garage-forest border border-garage-neon/30 rounded-lg text-white placeholder-white focus:ring-2 focus:ring-garage-neon focus:border-garage-neon transition-all"
                    required
                >
                @error('name') 
            ...
            <div>
                <label for="email" class="block text-sm font-bold text-white mb-2 service-tag tracking-wider">
            ...
            <div>
                <label for="phone" class="block text-sm font-bold text-white mb-2 service-tag tracking-wider">
                    PHONE NUMBER
                </label>
                <input 
                    type="text" 
    ...
    <div class="bg-gradient-to-br from-garage-charcoal to-garage-darkgreen rounded-lg shadow-garage p-6 border border-garage-neon/20">
        <div class="flex items-center space-x-3 mb-6">
            ...
            <h3 class="text-xl font-bold text-white service-tag tracking-wider">CHANGE PASSWORD</h3>
        </div>
        ...
        <form wire:submit.prevent="updatePassword" class="space-y-5">
            <div>
                <label for="current_password" class="block text-sm font-bold text-white mb-2 service-tag tracking-wider">
            ...
            <div>
                <label for="password" class="block text-sm font-bold text-white mb-2 service-tag tracking-wider">
            ...
            <div>
                <label for="password_confirmation" class="block text-sm font-bold text-white mb-2 service-tag tracking-wider">
    ...
    <div class="bg-gradient-to-br from-garage-charcoal to-garage-darkgreen rounded-lg shadow-garage p-6 border border-red-500/20">
        <div class="flex items-center space-x-3 mb-6">
            ...
            <h3 class="text-xl font-bold text-white service-tag tracking-wider">ACCOUNT ACTIONS</h3>
        </div>
        ...
        <div class="flex items-center justify-between">
            <div>
                <p class="text-white font-bold mb-1">Sign Out</p>
                <p class="text-sm text-white">Securely logout from your account</p>
            </div>
            <button 
                wire:click="logout" 
