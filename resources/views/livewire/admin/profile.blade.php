<div class="space-y-6">
    ...
    <div class="mb-4">
        <a href="{{ route('admin.dashboard') }}" wire:navigate class="inline-flex items-center px-6 py-3 bg-garage-forest hover:bg-garage-darkgreen text-white font-bold rounded-lg transition-all border border-garage-neon/30 hover:border-garage-neon/50 service-tag">
    ...
    <div class="bg-gradient-to-br from-garage-charcoal to-garage-darkgreen rounded-lg shadow-garage p-8 border-l-4 border-garage-neon relative overflow-hidden">
        ...
        <div class="relative z-10">
            <div class="flex items-center space-x-4 mb-3">
                ...
                <h1 class="text-4xl font-bold text-garage-offwhite service-tag tracking-wider">ADMIN PROFILE</h1>
            </div>
