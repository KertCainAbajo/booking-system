            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between h-16">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <a href="{{ route('admin.services') }}" class="text-gray-700 hover:text-blue-600 font-medium">Services</a>
                        <a href="{{ route('admin.bookings') }}" class="text-gray-700 hover:text-blue-600 font-medium">Bookings</a>
                        <a href="{{ route('admin.monitoring') }}" class="text-gray-700 hover:text-blue-600 font-medium">Monitoring</a>
